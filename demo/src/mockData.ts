...
export const physicians: Physician[] = [
  {
    ...
    source_detail: 'HCP Master List Q1 2026',
  ...
  },
  {
    ...
    record_status: 'validated',
    status_changed_at: '2026-01-20T09:15:00Z',
    status_changed_by: 'admin',
    decline_reason: null,
    source_channel: 'import',
    source_detail: 'Global KOL Import Q1 2026',
  ...
  },
  {
    ...
    record_status: 'validated',
    status_changed_at: '2026-01-22T14:00:00Z',
    status_changed_by: 'admin',
    decline_reason: null,
    source_channel: 'import',
    source_detail: 'HCP Master List Q1 2026',
  ...
  },
  {
    ...
    record_status: 'validated',
    status_changed_at: '2026-01-10T16:00:00Z',
    status_changed_by: 'admin',
    decline_reason: null,
    source_channel: 'import',
  ...
  },
  {
    ...
    institutional_role: 'Associate Professor',
    record_status: 'validated',
    status_changed_at: '2026-01-25T11:30:00Z',
    status_changed_by: 'admin',
    decline_reason: null,
    source_channel: 'import',
    source_detail: 'ITP Expert Panel Import',
  ...
  },
  {
    ...
    record_status: 'validated',
    status_changed_at: '2026-01-18T13:00:00Z',
    status_changed_by: 'admin',
    decline_reason: null,
    source_channel: 'import',
  ...
  },
  {
    ...
    status_changed_at: '2026-02-10T08:00:00Z',
  ...
  },
  {
    ...
    institutional_role: 'Associate Professor',
    record_status: 'validated',
    status_changed_at: '2026-02-02T11:00:00Z',
    status_changed_by: 'admin',
    decline_reason: null,
    source_channel: 'field_nomination',
  ...
  },
  {
    ...
    record_status: 'validated',
    status_changed_at: '2026-01-30T09:30:00Z',
    status_changed_by: 'admin',
    decline_reason: null,
    source_channel: 'import',
    source_detail: 'HCP Master List Q1 2026',
  ...
  },
  {
    ...
    status_changed_at: '2026-02-12T07:00:00Z',
    status_changed_by: 'field_rep',
    decline_reason: null,
    source_channel: 'field_nomination',
  ...
  },
  {
    ...
    institutional_role: 'Associate Professor',
    record_status: 'validated',
    status_changed_at: '2026-01-20T15:00:00Z',
    status_changed_by: 'admin',
    decline_reason: null,
    source_channel: 'import',
    source_detail: 'HCP Master List Q1 2026',
  ...
  },
  {
    ...
    institutional_role: 'Professor',
    record_status: 'validated',
    status_changed_at: '2026-01-15T14:00:00Z',
    status_changed_by: 'admin',
    decline_reason: null,
    source_channel: 'import',
    source_detail: 'ITP Expert Panel Import',
  ...
  },
  {
    ...
    institutional_role: 'Full Professor',
    record_status: 'validated',
    status_changed_at: '2026-01-12T10:00:00Z',
    status_changed_by: 'admin',
    decline_reason: null,
    source_channel: 'import',
    source_detail: 'HCP Master List Q1 2026',
  ...
  },
  {
    ...
    status_changed_at: '2026-02-18T12:00:00Z',
    status_changed_by: 'system',
    decline_reason: null,
  ...
  },
  {
    ...
    record_status: 'validated',
    status_changed_at: '2026-01-01T10:00:00Z',
    status_changed_by: 'admin',
    decline_reason: null,
    source_channel: 'import',
...
export const importBatches: ImportBatch[] = [
  {
    ...
    description: 'Q1 2026 master HCP list refresh',
    total_rows: 156,
    new_records: 12,
    updated_records: 8,
  ...
  {
    id: 'b003',
    filename: 'field_nominations_feb.csv',
    uploaded_by: 'Jennifer Lee',
    team: 'Field',
    description: 'February field nominations batch',
    total_rows: 22,
    new_records: 18,
    updated_records: 2,
    duplicate_records: 2,
    ...
    completed_at: '2026-02-10T11:01:00Z',
    pending_conflicts: 1,
  },
];
...
export const reviewQueueStats: ReviewQueueStats = {
  ...
  oldest_pending_date: '2026-02-05T14:00:00Z',
};
...
export function getPersona(physicianId: string): Persona | null {
  ...
  if (physicianId === 'p001') {
    ...
    prescribing.push(
      { period: 'Q4 2025', patients: 45, new_starts: 8, formulation: 'SC' },
      { period: 'Q3 2025', patients: 42, new_starts: 5, formulation: 'SC' },
    );
    competitive.push(
  ...
  if (physicianId === 'p004') {
    ...
    prescribing.push(
      { period: 'Q4 2025', patients: 120, new_starts: 15, formulation: 'IV' },
      { period: 'Q3 2025', patients: 115, new_starts: 12, formulation: 'IV' },
    );
    competitive.push(
  ...
  if (physicianId === 'p019') {
    ...
    prescribing.push(
      { period: 'Q4 2025', patients: 85, new_starts: 12, formulation: 'SC' },
      { period: 'Q3 2025', patients: 78, new_starts: 10, formulation: 'SC' },
    );
    competitive.push(
